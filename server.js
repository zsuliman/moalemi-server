...
`;
    ...
    // التعديل الجذري والنهائي: استخدام النسخة الاحترافية gemini-1.5-pro الأقوى والأكثر استقراراً
...
app.listen(PORT, () => { console.log(`🚀 Server running on port ${PORT} with Gemini 1.5 PRO`); });