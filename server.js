...
app.post('/ask', async (req, res) => {
  try {
    ...
    // دمجنا شخصية المعلم هنا لترسل كجزء من المحادثة العادية لتجاوز رفض جوجل
...
`;
    ...
    // إرسال السؤال مسبوقاً بالتعليمات
    ...
    // استخدمنا gemini-1.5-flash العادي بصيغة بسيطة لا يمكن رفضها
